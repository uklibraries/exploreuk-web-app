        ...
        <div class="slab__wrapper">
            <div class="global-header__banner">
                ...
                <a href="/" class="site-identity">
                    <div class="site-identity__main">
                        ...
                        <div class="site-identity__wordmark">
                            <span class="site-identity__wordmark__row--subhead">Special Collections Research Center</span>
                            <span class="site-identity__wordmark__row">ExploreUK</span>
                        </div>
                    </div>
                </a>
                <!-- @limestone/site-identity.twig" -->
                <!-- @limestone/utility-nav.twig" -->
                <nav id="UtilityNav660c465a9ed01" class="utility-nav" aria-labelledby="UtilityNavLabel660c465a9ed00">
                    ...
                    <a href="https://libraries.uky.edu/ContactSCRC">Contact</a>
                    <a href="https://libraries.uky.edu/locations/special-collections-research-center">Visit</a>
                    
                </nav>
                <!-- @limestone/utility-nav.twig" -->
                <!-- @limestone/menu-button.twig" -->
                <!-- @limestone/toggle-button.twig" -->
                <!-- @limestone/icon-button.twig" -->
                <button
...
<div class="slab mobile-nav" hidden id="MobileNav">
    <div class="slab__wrapper">
        <div class="mobile-tab-nav">
            ...
            <div id="mobile-nav-content" class="tabs__content">
                ...
                <!-- @limestone/universal-nav.twig" -->
                <div class="mobile-tab-nav__universal">
                    <div class="universal-nav" aria-labelledby="UniversalNavLabel-6998bc0c1a2ed">
                        <div class="show-for-sr" id="UniversalNavLabel-6998bc0c1a2ed">University-wide Navigation</div>
                            <!-- @atoms/my-uk-logo.html.twig" -->
